  ...
  return (
    <div className="productScreen">
      <div className="navLinks">
        ...
        <Link className="links" to={'/products/' + location.productDetail.category}>
      ...
      <div className="productDetailContent row">
        <div className="productDetailLeftp col-lg-4 col-md-4">
          <div className="imageScroll">
            <img className="leftImg" src={location.productDetail.src[index]} alt="product name" />
          </div>
          <div className="productImages">
            <ImagesThumb images={location.productDetail.src} tab={handleTab} imageRef={imageRef} />
          </div>
        </div>
